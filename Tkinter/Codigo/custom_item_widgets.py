...
class ItemLinea(ItemWidgetBasico):
    def __init__(self, titulo="", texto_base="", texto_boton="", columna=1, parent=None):
        super().__init__(parent)
        ...
        self.crear_wgt(self.linea, columna, spacerR=texto_boton == "")
        if texto_boton:
...
class ItemTitulo(ItemWidgetBasico):
    def __init__(self, texto, columna=0, parent=None, centrado=False, spanned=False):
        super().__init__(parent)
        self.texto = QtWidgets.QLabel(texto)
    ...
    def setDisabled(self, disabled):
        self.texto.setDisabled(disabled)
...
class ItemRadio(ItemWidgetBasico):
    ...
    def setAutoExclusive(self, *args):
        pass

class WidgetClickeable(QtWidgets.QWidget):
...
class ItemCustomWidget(QtWidgets.QTreeWidgetItem):
    def __init__(self, parent, custom_widget, column=0):
        super().__init__(parent)
        self.wgt = custom_widget
        self.treeWidget().setItemWidget(self, column, custom_widget)

    def setDisabled(self, disabled):
        self.wgt.setDisabled(disabled)